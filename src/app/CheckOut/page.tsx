      ...
      <div className="container mx-auto px-4 lg:px-12 mt-16 mb-10">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
          ...
          <div className="w-full lg:w-[60%]">
            ...
            <br />
            <select
              className="w-full lg:w-[453px] h-[75px] border border-black rounded-md pl-4 pr-10 cursor-pointer"
            >
          ...
          <div className="w-full lg:w-[35%]">
            ...
            <div className="mt-10">
              <button className="w-full lg:w-[318px] h-[64px] border border-black rounded-2xl hover:bg-gray-300">Place order</button>
            </div>
          </div>
        </div>
      </div>
