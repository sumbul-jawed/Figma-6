...
const Page = () => {
  ...
  return (
    <>
      ...
      {/* Combined Section */}
      <div className="flex flex-wrap items-start justify-between mt-8 ml-40 relative">
        {/* Text Section */}
        ...
        <div className="flex gap-8">
          ...
          <div className="flex flex-col gap-2">
            <Image src="/images/PC1.png" alt="Asgaard Sofa" width={250} height={177} className='mt-5' />
        ...
        <div className="flex flex-col w-full sm:w-1/3 mt-8 sm:mt-0">
          ...
          <div className="relative mt-4 sm:mt-6">
            <button className="flex items-center justify-between w-full sm:w-[242px] h-[39px] text-white bg-[#B88E2F] px-4 rounded-md" onClick={() => setDropdown(!dropdown)}>
              Choose a Product
              <span className="ml-2"><IoIosArrowDown /></span> {/* Optional */}
            </button>
            {/* Fixed issue with className in ul */}
            <ul className={`absolute ${dropdown ? "block" : "hidden"} bg-white border border-gray-300 rounded-md w-full sm:w-[242px] mt-2 z-10`}>
      ...
      <div className="flex flex-wrap items-start justify-between mt-14 ml-40 w-full px-4">
        {/* General Details */}
      ...
      {/* Product Details */}
      <div className="flex flex-wrap items-start justify-between mt-14 w-full px-4 ml-40">
        {/* Labels */}
        <div className="flex flex-col gap-6 text-[18px] sm:text-[20px] w-full sm:w-1/3 mb-6 sm:mb-0">
      ...
      {/* Warranty Details */}
      <div className="flex flex-wrap items-start justify-between mt-14 sm:text-[20px] text-[18px] sm:px-6 px-4 ml-40">
